...
class Product(models.Model):
    ...
    fat_100g = models.DecimalField(max_digits=4, decimal_places=1)
    saturated_fat = models.CharField(max_length=8)
    saturated_fat_100g = models.DecimalField(max_digits=4, decimal_places=1)
    sugars = models.CharField(max_length=8)
    sugars_100g = models.DecimalField(max_digits=4, decimal_places=1)
    salt = models.CharField(max_length=8)
    salt_100g = models.DecimalField(max_digits=4, decimal_places=1)
